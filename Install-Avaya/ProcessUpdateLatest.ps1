...
function listsDespegar {
    ...
    $Global:listurl = @(
    "https://api.github.com/repos/despegar/Scripts-Win10/releases/assets/54285385", #Pre.zip
    "https://api.github.com/repos/despegar/Scripts-Win10/releases/assets/54285393", #Tsapi
    #"https://api.github.com/repos/franklin-gedler/Scripts-Win10/releases/assets/30567056",
    "https://api.github.com/repos/despegar/Scripts-Win10/releases/assets/54285310", #Avaya
    "https://api.github.com/repos/despegar/Scripts-Win10/releases/assets/54285352", #certificadossl.zip
    "https://api.github.com/repos/despegar/Scripts-Win10/releases/assets/54285354", # ClickTodial
    "https://api.github.com/repos/despegar/Scripts-Win10/releases/assets/54285356", # cti
    "https://api.github.com/repos/despegar/Scripts-Win10/releases/assets/54285358" # DisableorEnable
    )
    
    $Global:listfiles = @(
    "Downloads\Pre.zip",
    "Downloads\TsapiClient.zip",
    "Downloads\AvayaOneX_NEW.zip",
    "Downloads\CertificadoSSL.zip",
    "Downloads\ClickToDial.zip",
    "Downloads\CTI.zip",
    "Downloads\DisableOREnable.zip"
...
Function showmenumain {
    ...
    Write-Host "  2. Usuario Falabella (No usar) " -ForegroundColor Yellow -BackgroundColor Black
    Write-Host "  3. Reparar (No Usar)  " -ForegroundColor Yellow -BackgroundColor Black
    Write-Host "  4. Mover Equipo OU  (No usar)  " -ForegroundColor Yellow -BackgroundColor Black
    Write-Host "  5. Exit               " -ForegroundColor Yellow -BackgroundColor Black
    Write-Host " ********************** "
    Write-Output ""
}
