...
Invoke-WebRequest -Headers $headers -Uri "https://raw.githubusercontent.com/despegar/Scripts-Win10/main/Prepare-Win10/ProcessUpdateRegional.ps1" -UseBasicParsing -OutFile "$PSScriptRoot\ProcessUpdateRegional.ps1"
