function DellCommandUpdate {
    ...
    if("$machinebrand" -eq "Dell Inc."){
        ...
        if($StateDellUpdate -eq $False){
            ...
            $URLinstaller = 'https://github.com/despegar/Scripts-Win10/releases/download/2/Dell_Command_Update_GRVPK_WIN_4.3.0_A00_03.exe'
            ...
            Start-Process -Wait C:\PrepareWin10\Dell-Command-Update-Application-for-Windows-10_GRVPK_WIN_4.3.0_A00_03.EXE -ArgumentList '/s'
            #---------------------------------------------------------------------------------------------------------------------------------
